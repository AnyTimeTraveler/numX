...
// Implement TryFrom for all unsigned integer

implement_try_from!([u2, u3, u4, u5, u6, u7], u8);
implement_try_from!([u9, u10, u11, u12, u13, u14, u15], u16);
implement_try_from!([u17, u18, u19, u20, u21, u22, u23, u24, u25, u26, u27, u28, u29, u30, u31], u32);
implement_try_from!([u33, u34, u35, u36, u37, u38, u39, u40, u41, u42, u43, u44, u45, u46, u47, u48,
                     u49, u50, u51, u52, u53, u54, u55, u56, u57, u58, u59, u60, u61, u62, u63], u64);

#[cfg(has_u128)]
implement_try_from!([u65, u66, u67, u68, u69, u70, u71, u72, u73, u74, u75, u76, u77, u78, u79, u80,
                     ...
                     u124, u125, u126, u127], u128);

// Implement TryFrom for all signed integer

implement_try_from!([i2, i3, i4, i5, i6, i7], i8);
implement_try_from!([i9, i10, i11, i12, i13, i14, i15], i16);
implement_try_from!([i17, i18, i19, i20, i21, i22, i23, i24, i25, i26, i27, i28, i29, i30, i31], i32);
implement_try_from!([i33, i34, i35, i36, i37, i38, i39, i40, i41, i42, i43, i44, i45, i46, i47, i48,
                     i49, i50, i51, i52, i53, i54, i55, i56, i57, i58, i59, i60, i61, i62, i63], i64);

#[cfg(has_i128)]
implement_try_from!([i65, i66, i67, i68, i69, i70, i71, i72, i73, i74, i75, i76, i77, i78, i79, i80,
...
mod tests {
    ...
    #[test]
    fn test_conversion_try_unsigned() {
        assert_eq!(Ok(u2(0)), u2::try_from(0u8));
        assert_eq!(Ok(u2(1)), u2::try_from(1u8));
        assert_eq!(Ok(u2(2)), u2::try_from(2u8));
        assert_eq!(Ok(u2(3)), u2::try_from(3u8));
        assert_eq!(Err("Out of range!"), u2::try_from(4u8));
        assert_eq!(Err("Out of range!"), u2::try_from(5u8));
    }
    
    #[test]
    fn test_conversion_try_signed() {
        assert_eq!(i2::try_from(-3i8), Err("Out of range!"));
        assert_eq!(i2::try_from(-2i8), Ok(i2(-2)));
        assert_eq!(i2::try_from(-1i8), Ok(i2(-1)));
        assert_eq!(i2::try_from(0i8), Ok(i2(0)));
        assert_eq!(i2::try_from(1i8), Ok(i2(1)));
        assert_eq!(i2::try_from(2i8), Err("Out of range!"));
        assert_eq!(i2::try_from(3i8), Err("Out of range!"));
        assert_eq!(i2::try_from(4i8), Err("Out of range!"));
    }
